...
export const en: MessageCatalog = {
	...
	"debug.preview.recap": "Session recap",
	...
	"settings.sessionRecap.title": "Desk session recap",
	...
	"rewards.category.cosmetic": "Cosmetic",
	"rewards.category.utility": "Utility",
	"rewards.category.meta": "Meta",
	"rewards.equip": "Equip",
	"rewards.equipped": "Equipped",
	"rewards.stockProgress": "{count}/{max}",
	"rewards.cheerSound": "Cheer sound",
	"rewards.cheerSoundDesc":
		"Pick a celebration pattern or Random to cycle all families each cheer.",
	"rewards.popupColors": "Popup colors",
	"rewards.popupColorsDesc":
		"Unlock Aurora or Sunset in the shop below, then pick one active preset. Each adds an animated outer glow to popups (only one active at a time).",
	"rewards.popupPreset.custom": "Custom",
	"rewards.popupPreset.lockedHint": "Buy in the shop below",
	"rewards.cheerTheme.random": "Random",
	"rewards.cheerTheme.classic": "Classic",
	"rewards.cheerTheme.bounce": "Bounce",
	"rewards.cheerTheme.fanfare": "Fanfare",
	"rewards.cheerTheme.sparkle": "Sparkle",
	"rewards.cheerTheme.chime": "Chime",
	"rewards.cheerTheme.waltz": "Waltz",
	"rewards.cheerThemeBounce": "Bounce cheer",
	"rewards.cheerThemeBounceDesc": "Unlock the Bounce pattern to equip as your cheer sound.",
	"rewards.cheerThemeFanfare": "Fanfare cheer",
	"rewards.cheerThemeFanfareDesc": "Unlock the Fanfare pattern to equip as your cheer sound.",
	"rewards.cheerThemeSparkle": "Sparkle cheer",
	"rewards.cheerThemeSparkleDesc": "Unlock the Sparkle pattern to equip as your cheer sound.",
	"rewards.popupPresetAurora": "Aurora popup",
	"rewards.popupPresetAuroraDesc": "Cool teal popups with a pulsing cyan glow.",
	"rewards.popupPresetSunset": "Sunset popup",
	...
	"stats.clearDesc":
		"Clearing statistics permanently deletes blink, session, and eye-care history. This cannot be undone.",
	"stats.clear": "Clear statistics",
	"stats.clearConfirm":
		"Clear all blink, session, and eye-care statistics? This cannot be undone.",
	...
	"tray.hushLonger": "Hush longer…",
	"tray.hushDuration": "Hush for {n} min",
	"tray.hushDuration_few": "Hush for {n} min",
	"tray.hushDuration_plural": "Hush for {n} min",
	"tray.hushUntilResume": "Until I resume",
	...
	"tray.endHushMinutes": "End hush ({n} min left)",
	"tray.endHushMinutes_few": "End hush ({n} min left)",
	"tray.endHushMinutes_plural": "End hush ({n} min left)",
	"hush.active": "Prompts hushed",
	"hush.activeMinutes": "Prompts hushed ({n} min left)",
	"hush.activeMinutes_few": "Prompts hushed ({n} min left)",
	"hush.activeMinutes_plural": "Prompts hushed ({n} min left)",
	"hush.activeUntilResume": "Prompts hushed until you resume",
	...
	"popup.recap.lookAwayCount_plural": "{n} look-aways",
	"popup.recap.exerciseCount": "{n} exercise",
